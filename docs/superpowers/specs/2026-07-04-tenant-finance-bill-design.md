...
> 2026-07-19 边界更新：本文中的员工提成、佣金查询和佣金作为 `BillEntry` 的设计，已由 [签约业绩、佣金审核与员工收益设计](2026-07-19-signing-performance-compensation-design.md) 重新划归独立 `performance` 业务域。本文后续仅作为经营账单方向的历史草案；收入、成本、收款、付款仍可参考，员工权益、审核和排行不再以财务条目为权威来源。
