...
def get_my_real_name(request):
    ...
    return {
        ...
        "provider__mapping": RealNameProvider.get_choice_label(RealNameProvider.MOCK_AUTO),
        "provider_request_id": "",
        "provider_result": {},
        "id_card_media": [],
        "real_name_masked": request.user.real_name_masked,
        ...
        "source__mapping": RealNameSource.get_choice_label(RealNameSource.USER_SUBMIT),
        "status": request.user.real_name_status,
        "status_label": RealNameStatus.get_choice_label(request.user.real_name_status),
        "status__mapping": RealNameStatus.get_choice_label(request.user.real_name_status),
        "updated_at": "",
    }
