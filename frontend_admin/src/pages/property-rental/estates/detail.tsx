...
const EstateDetailPage: React.FC = () => {
  ...
  const editHref = dashboardHref(
    `/property-rental/estates?estate_edit=${estate.id}`,
  );
  const createBuildingHref = dashboardHref(
    `/property-rental/estates?view=buildings&building_create=${estate.id}`,
  );
  ...
  const mapHref = dashboardHref(`/property-rental/map?${mapParams.toString()}`);
            ...
            <Card
              ...
              extra={
                <Space wrap>
                  <a
                    href={dashboardHref(
                      `/property-rental/estates?view=buildings&estate_id=${estate.id}`,
                    )}
                  >
                    查看全部楼栋
                  </a>
                    ...
                    render: (value, row) => (
                      <div>
                        <Link
                          ...
                          to={`/property-rental/buildings/${row.id}`}
                        >
                          {value}
                        </Link>
