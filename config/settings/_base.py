...
# 微信支付渠道（收款与出款）
PAYMENTS_WECHAT_PAY_ENABLED = env.bool("PAYMENTS_WECHAT_PAY_ENABLED", default=False)
PAYMENTS_WECHAT_PAYOUT_ENABLED = env.bool("PAYMENTS_WECHAT_PAYOUT_ENABLED", default=False)
PAYMENTS_WECHAT_MCH_ID = env("PAYMENTS_WECHAT_MCH_ID", default="")
PAYMENTS_WECHAT_SERIAL_NO = env("PAYMENTS_WECHAT_SERIAL_NO", default="")
PAYMENTS_WECHAT_PRIVATE_KEY = env("PAYMENTS_WECHAT_PRIVATE_KEY", default="")
PAYMENTS_WECHAT_PLATFORM_CERT = env("PAYMENTS_WECHAT_PLATFORM_CERT", default="")
PAYMENTS_WECHAT_API_V3_KEY = env("PAYMENTS_WECHAT_API_V3_KEY", default="")
PAYMENTS_WECHAT_API_BASE_URL = env("PAYMENTS_WECHAT_API_BASE_URL", default="https://api.mch.weixin.qq.com")
PAYMENTS_WECHAT_TIMEOUT_SECONDS = env.int("PAYMENTS_WECHAT_TIMEOUT_SECONDS", default=8)
PAYMENTS_WECHAT_NATIVE_APP_ID = env("PAYMENTS_WECHAT_NATIVE_APP_ID", default="")
PAYMENTS_WECHAT_MINIPROGRAM_APP_ID = env("PAYMENTS_WECHAT_MINIPROGRAM_APP_ID", default="")
PAYMENTS_WECHAT_PAYMENT_NOTIFY_URL = env("PAYMENTS_WECHAT_PAYMENT_NOTIFY_URL", default="")
PAYMENTS_WECHAT_PAYOUT_APP_ID = env("PAYMENTS_WECHAT_PAYOUT_APP_ID", default="")
PAYMENTS_WECHAT_PAYOUT_NOTIFY_URL = env("PAYMENTS_WECHAT_PAYOUT_NOTIFY_URL", default="")
PAYMENTS_WECHAT_TRANSFER_SCENE = env("PAYMENTS_WECHAT_TRANSFER_SCENE", default="ORDINARY_TRANSFER")
PAYMENTS_TEST_AMOUNT_CENTS = env.int("PAYMENTS_TEST_AMOUNT_CENTS", default=0)
...
ALIYUN_SMS_INVITATION_TEMPLATE_CODE = env("ALIYUN_SMS_INVITATION_TEMPLATE_CODE", default="")
ALIYUN_SMS_INVITATION_CANCELLATION_TEMPLATE_CODE = env("ALIYUN_SMS_INVITATION_CANCELLATION_TEMPLATE_CODE", default="")
...
TENCENT_SMS_INVITATION_TEMPLATE_ID = env("TENCENT_SMS_INVITATION_TEMPLATE_ID", default="")
TENCENT_SMS_INVITATION_CANCELLATION_TEMPLATE_ID = env("TENCENT_SMS_INVITATION_CANCELLATION_TEMPLATE_ID", default="")
