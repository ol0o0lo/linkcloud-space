...
// Mock content views
vi.mock('../settings/components/base', () => ({
  default: () => <div>个人资料内容</div>,
}));
vi.mock('../settings/components/security-overview', () => ({
  default: () => <div>账号安全内容</div>,
}));
vi.mock('../settings/components/notification', () => ({
  default: () => <div>通知设置内容</div>,
}));
