    ...
    ? [
        ...
        },
        {
          ...
          label: (
            <a
              href={dashboardHref(
                `/property-rental/leases?house_id=${houseId}`,
              )}
            >
              新建租约
            </a>
        ...
        { type: 'divider' as const },
        {
          ...
          label: (
            <a href={dashboardHref('/property-rental/houses')}>返回列表</a>
          ),
        },
      ]
    : [];
    ...
    <TenantSelectionGuard title={false}>
      {!validHouseId ? (
        <Result
          ...
          extra={
            <Button type="primary" href="/dashboard/property-rental/houses">
              返回房源列表
            </Button>
          }
        />
        ...
        <Result
          ...
          extra={
            <Space wrap>
              <Button href="/dashboard/property-rental/houses">
                返回房源列表
              </Button>
              {detailErrorCode !== 404 ? (
          ...
          <Row gutter={[16, 16]} align="top">
            ...
            <Col xs={24} xl={8}>
              <HouseLocationPoiCard
                ...
                returnTo={
                  typeof window === 'undefined'
                    ? `/dashboard/property-rental/houses/${houseId}`
      ...
      <Modal
        ...
        title={
          publishConfirmStatus === HOUSE_STATUS.LISTED ? '确认发布房源' : '确认下架房源'
        }
