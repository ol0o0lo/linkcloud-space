...
const { mockListAccounts, mockLedger, mockAdjust } = vi.hoisted(() => ({
...
describe('WalletAccountsPage', () => {
      ...
      items: [
        {
          ...
          amount_delta: 500,
          available_balance_after: 1700,
          frozen_balance_after: 100,
          biz_type: 'manual',
          biz_id: 'adj-1',
          remark: '补贴',
  ...
  it('loads ledger entries and submits an adjustment', async () => {
    render(
