export default {
  ...
  'menu.property-rental.responsibilities': 'Staff Assignments',
  ...
  'menu.tenant-operations': 'Organization Operations',
  'menu.tenant-operations.workbench': 'Team Workbench',
  'menu.tenant-operations.announcements': 'Team Announcements',
  'menu.tenant-operations.tasks': 'Team Tasks',
  'menu.tenant-operations.notification-dispatches': 'Notification Dispatches',
