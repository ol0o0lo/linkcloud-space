...
def get_me(request):
    ...
    return {
        ...
        "real_name_status__mapping": enum_mapping(RealNameStatus, request.user.real_name_status),
...
def get_my_real_name(request):
    ...
    return {
        ...
        "provider__mapping": enum_mapping(RealNameProvider, RealNameProvider.MOCK_AUTO),
        "provider_request_id": "",
        "provider_result": {},
        "id_card_media": [],
        "real_name_masked": request.user.real_name_masked,
        ...
        "source__mapping": enum_mapping(RealNameSource, RealNameSource.USER_SUBMIT),
        "status": request.user.real_name_status,
        "status_label": RealNameStatus.get_choice_label(request.user.real_name_status),
        "status__mapping": enum_mapping(RealNameStatus, request.user.real_name_status),
        "updated_at": "",
    }
