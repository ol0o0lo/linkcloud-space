export default {
  ...
  'menu.property-rental.responsibilities': '员工分工',
  ...
  'menu.tenant-operations.workbench': '团队工作台',
  'menu.tenant-operations.announcements': '团队公告',
  'menu.tenant-operations.tasks': '团队任务',
