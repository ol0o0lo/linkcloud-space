    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending_review', '待审核'), ('cancelled', '已撤销'), ('rejected', '已驳回'), ('approved', '已通过待打款'), ('paying', '打款中'), ('paid', '已打款'), ('failed', '打款失败')], default='pending_review', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', '待发起'), ('processing', '处理中'), ('succeeded', '成功'), ('failed', '失败')], default='pending', max_length=32)),
